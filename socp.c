...
/**
 * Verifica se o ficheiro fonte existe e cria um novo ficheiro no diretório de destino
...
/**
 * Verifica se o ficheiro fonte existe e cria um novo ficheiro no diretório de destino (wrapper)
